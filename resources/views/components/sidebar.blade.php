<div>
    <div class="nftmax-smenu">
        <div class="logo">
            <a href="index.html">
                <img class="nftmax-logo__main" src="{{ asset('/admin_assets/assets/images/logo/Logo.svg') }}"
                    alt="logo">
            ...
            <div class="admin-menu__one">
                ...
                <div class="menu-bar">
                    <ul class="sidebar_nav">
                        ...
                        <li class="menu-main">
                            <a href="{{ url('/admin/dashboard') }}" class="{{ $pageId == 1 ? 'active' : '' }}">
                        ...
                        <li class=" menu-main ">
                            <a href="{{ route('admin.category') }}" class="{{ $pageId == 2 ? 'active' : '' }}">
                                <div class="has-child-main">
                                    <div class="has-child-main-inner">
                                        <div class="has-child-icon">
                                            <span>
                        ...
                        <li class=" menu-main ">
                            <a href="{{ route('admin.coupon') }}" class="{{ $pageId == 3 ? 'active' : '' }}">
                                <div class="has-child-main">
                                    <div class="has-child-main-inner">
                                        <div class="has-child-icon">
                                            <span>
                        ...
                        <li class=" menu-main ">
                            <a href="{{ route('admin.size') }}" class="{{ $pageId == 4 ? 'active' : '' }}">
                                <div class="has-child-main">
                                    <div class="has-child-main-inner">
                                        <div class="has-child-icon">
                                            <span>
                        ...
                        <li class=" menu-main ">
                            <a href="{{ route('admin.color') }}" class="{{ $pageId == 5 ? 'active' : '' }}">
                                <div class="has-child-main">
                                    <div class="has-child-main-inner">
                                        <div class="has-child-icon">
                                            <span>
                        ...
                        <li class="menu-main">
                            <a href="{{ route('admin.product') }}" class="{{ $pageId == 6 ? 'active' : '' }}">
                                <div class="has-child-main">
                                    <div class="has-child-main-inner">
                                        <div class="has-child-icon">
                                            <span>
                                        ...
                                        <div class="has-child-icon">
                                            <span>
                                                <svg width="18" height="21" viewBox="0 0 18 21"
                                                    ...
                                                    <circle cx="13" cy="14" r="1" class="path-2">
                                                    </circle>
                                                    <circle cx="5" cy="14" r="1" class="path-2">
                                                    </circle>
                                                </svg>
                                            </span>
                                        </div>
                            ...
                            <a href="coming-soon.html">
                                <div class="has-child-main">
                                    <div class="has-child-main-inner">
                                        <div class="has-child-icon">
                                            <span>
                                                <svg width="18" height="21" viewBox="0 0 24 24"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
