...
<body>
    <div class="body-bg">
        ...
        <!-- Start Header -->
        <x-navbar pageName="Add Category" />
        <!-- End Header -->
            ...
            <div class=" nftmax-adashboard-left ">
                <div class="row tabel-main-box">
                    <div class="col-12 text-end">
                        <a href="{{ route('admin.category') }}" class="btn btn-warning text-center px-2 py-1">Back
                        </a>
                    </div>
                    <div class="col-lg-12">
                        <form action="{{ route('admin.category.manage') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-12 col-lg-6 mb-3">
                                    <label for="" class="form-label">Category</label>
                                    <input type="text" name="category_name" id="" value="{{$category_name}}" class="form-control py-2"
                                        placeholder="Enter category name" >
                                    @if ($errors->has('category_name'))
                                        <span class="text-danger ps-2">{{ $errors->first('category_name') }}</span>
                                    @endif
                                </div>
                                <div class="col-12 col-lg-6 mb-3">
                                    <label for="" class="form-label">Category Slug</label>
                                    <input type="text" name="category_slug" id="" value="{{$category_slug}}" class="form-control py-2"
                                        placeholder="Enter category slug" >
                                    @if ($errors->has('category_slug'))
                                        <span class="text-danger ps-2">{{ $errors->first('category_slug') }}</span>
                                    @endif
                                </div>
