            ...
            <div class=" nftmax-adashboard-left ">
                <div class="row tabel-main-box">
                    <div class="col-12 text-end">
                        <a href="{{ route('admin.color') }}" class="btn btn-warning text-center px-2 py-1">Back
                        </a>
                    </div>
                    <div class="col-lg-12">
                        <form action="{{ route('admin.color.manage') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-12 col-lg-6 mb-3">
                                    <label for="" class="form-label">Color</label>
                                    <input type="text" name="color" id=""
                                        value="{{ $color }}" class="form-control py-2"
                                        placeholder="Enter Color">
                                    @if ($errors->has('color'))
                                        <span class="text-danger ps-2">{{ $errors->first('color') }}</span>
                                    @endif
                                </div>
