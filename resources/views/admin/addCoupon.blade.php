            ...
            <div class=" nftmax-adashboard-left ">
                <div class="row tabel-main-box">
                    <div class="col-12 text-end">
                        <a href="{{ route('admin.coupon') }}" class="btn btn-warning text-center px-2 py-1">Back
                        </a>
                    </div>
                    <div class="col-lg-12">
                        <form action="{{ route('admin.coupon.manage') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-12 col-lg-6 mb-3">
                                    <label for="" class="form-label">Title</label>
                                    <input type="text" name="title" id=""
                                        value="{{ $title }}" class="form-control py-2"
                                        placeholder="Enter title">
                                    @if ($errors->has('title'))
                                        <span class="text-danger ps-2">{{ $errors->first('title') }}</span>
                                    @endif
                                </div>
                                <div class="col-12 col-lg-6 mb-3">
                                    <label for="" class="form-label">Code</label>
                                    <input type="text" name="code" id=""
                                        value="{{ $code }}" class="form-control py-2"
                                        placeholder="Enter Code">
                                    @if ($errors->has('code'))
                                        <span class="text-danger ps-2">{{ $errors->first('code') }}</span>
                                    @endif
                                </div>
                                <div class="col-12 col-lg-6 mb-3">
                                    <label for="" class="form-label">Value</label>
                                    <input type="number" name="value" id=""
                                        value="{{ $value }}" class="form-control py-2"
                                        placeholder="Enter value">
                                    @if ($errors->has('value'))
                                        <span class="text-danger ps-2">{{ $errors->first('value') }}</span>
                                    @endif
                                </div>
